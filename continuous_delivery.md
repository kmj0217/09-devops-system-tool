...
——支持把其他服务作为流水线任务，包括但不限于代码拉取、代码检查、编译构建、部署、测试、发布等
...
——支持流水线内容及结果的通知，包括但不限于即时消息、电子邮件、短信服务
...
环境是指应用安装和运行所需要的关联资源及其配置描述，环境管理确保应用在多个环境之间达到一致性交付的目的。
